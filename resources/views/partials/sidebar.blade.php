                        ...
                        @if (Gate::check('view system_user') || Gate::check('view role'))
                            @can('view role')
                                <li>
                                    ...
                                    class="nav-link text-white nav-link-hover {{ request()->routeIs('role-list') ? 'active' : '' }}"
                            ...
                            @can('view system_user')
                                <li>
                                    ...
                                    class="nav-link text-white nav-link-hover {{ request()->routeIs('user-list') ? 'active' : '' }}"
                                    style="font-size:13px;">
                            ...
                            @can('view loghistory')
                                <li>
                                    ...
                                    class="nav-link text-white nav-link-hover {{ request()->routeIs('logHistory-list') ? 'active' : '' }}"
                                    style="font-size:13px;">
