...
@section('stylesheet')
<link href="{{ asset('dashboard/css/term.css') }}" rel="stylesheet" />
@endsection
{{-- BEGIN:: Table Content --}}
@section('content')
<div class="row">
    <div class="col-md-12 d-flex justify-content-between mt-2">
        <h4 class="title"> Term List</h4>
        <!-- <button type="button"
            ...
            <div class="card-body">
                <div class="table-responsive" style="padding-bottom: 0 !important">
                    <table class="table tablesorter " id="">
                        ...
                        <tbody>
                            <!-- Row 1: Generation 2025 -->
                            <tr>
                                <td colspan="4" class="text-left">Generation 2025</td>
                            </tr>
                            <tr>
                                <td class="text-left">1</td>
                                <td class="text-right">Term-1</td>
                                <td class="text-center">Web_2025A, Web_2025B, SNA_2025</td>
                                <td class="text-right">
                            ...
                            <!-- Row 2: Generation 2026 -->
                            <tr>
                                <td colspan="4" class="text-left">Generation 2026</td>
                            </tr>
                            <tr>
                                <td class="text-left">1</td>
                                <td class="text-right">Term-1</td>
