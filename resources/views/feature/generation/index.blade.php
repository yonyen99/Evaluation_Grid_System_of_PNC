    ...
    <div class="row">
        <div class="col-md-12 d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-outline-primary d-flex align-items-center">
                ...
                <a href="{{ route('generation-add') }}">New Generate</a>
            </button>
        </div>
        <!-- Table List -->
        <div class="col-md-12">
                            ...
                            <tbody>
                                @foreach ($generations as $index => $generation)
                                    <tr>
                                        ...
                                        <!-- Action -->
                                        <td class="text-right">
                                            <form class="btn btn-sm btn-danger" action="{{ route('generation-delete', ['id' => $generation->id]) }}" method="POST" >
                                                @method('delete')
                                                @csrf
                                            ...
                                            <a class="btn btn-sm btn-warning" href="{{ url("generation/$generation->id/edit") }}">
                                                <button type="button" class="btn-warning" click="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            ...
                                            <a class="btn btn-sm btn-info" href="">
                                                <button type="button" class="btn-info" click="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('.btn-danger').on('click', function(){
                return confirm('Do you really want to delete this Generation record?');
            });
