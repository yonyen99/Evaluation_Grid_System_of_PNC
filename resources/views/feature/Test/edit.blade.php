    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <form action="{{ route('test-update', ['id' => $test->id])}}" method="POST" id="color-form" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <div class="form-row">
                            <div class="form-group col-md-6"> <!--test name -->
                                ...
                                <input type="text"  name="name" class="form-control"
                                    placeholder="test name" value="{{$test->name}}" >
                            </div>
                            <div class="form-group col-md-6"> <!--test salery -->
                                ...
                                <input type="number" name="salery" class="form-control"
                                    placeholder="test salery"  value="{{$test->salery}}">
                            </div>
                        </div>
