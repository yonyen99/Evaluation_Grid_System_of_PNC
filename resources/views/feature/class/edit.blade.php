...
@section('content')
    <div class="row d-flex justify-content-center">
        <div class="col-sm-12 col-md-12 col-xl-12">
            <h3 class="title mt-5">Edit Class</h3>
            <form class="card-form" action="{{ route('class-update', $class->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg" id="class_name"
                            value="{{ old('name', $class->name) }}" placeholder="Enter class name" required>
                    </div>
                                    ...
                                    <select name="teachers[]" class="form-select" required>
                                        @foreach ($teachers as $teacher)
                                            <option value="{{ $teacher->id }}"
                                                {{ $teacher->id == $oldTeachers[$index] ? 'selected' : '' }}>
                ...
                <div class="d-flex justify-content-between gap-3">
                    <a href="{{ route('class') }}" class="btn btn-outline-secondary px-4">
