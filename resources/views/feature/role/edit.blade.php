    ...
    <div class="edit-role-content-wrapper mt-3">
        <form id="role-form" action="{{ route('role-update', ['id' => $role->id]) }}" method="POST"
            ...
            <div class="general-info-wrapper">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" value="{{ $role->name }}" minlength="2" maxlength="30"
            ...
            <div class="sales-btn-wrapper form-row mt-4">
                <input type="submit" class="btn btn-outline-info mr-2" value="Update Role">
