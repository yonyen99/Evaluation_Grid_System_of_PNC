...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => 'student'], function () {
        ...
        Route::get('/add', [StudentController::class, 'create'])->name('student-add'); // Show form create
        Route::post('/create', [StudentController::class, 'store'])->name('student-create'); // input data form to database
